...
function Truck(
  ...
  let truck = Vehicle.call(this, brand, model, year, mileage);
  this.color = color;
...
Car.prototype.drive = function(distance) {
  ...
  console.log(`Подорожуємо ${distance} кілометрів у ${this.brand} ${this.model}.`);
};

// Використовуємо bind для зв'язування методу drive з конкретним об'єктом car.
let carDrive = Car.prototype.drive.bind(car);
